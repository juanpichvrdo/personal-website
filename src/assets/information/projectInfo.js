...
const projectInfo = [
  {
    ...
    projectInfoText:
      'Taste Discovery is a web app that allows users find recommendations and helps them discover new music, movies, TV shows, books and games, based on what they like. Users can search all categories, or limit their search to one specific category. The app displays information about the recommendations and provides Youtube videos related to the recommendations when available. Information is fetched from TasteDive API. Made with React and hosted on Netlify.',
    languajes: [
      { className: 'icon-css3' },
  ...
  },
  {
    ...
    projectInfoText:
      'LyricSrapper is a web app that finds the lyrics of a song providing the name of the artist and title of the song. Song lyrics are fetched from lyrics.ovh API. Made with React and hosted on Netlify.',
    languajes: [
      { className: 'icon-css3' },
      { className: 'icon-react' },
      { className: 'icon-javascript' },
  ...
  },
  {
    ...
    projectInfoText:
      "facileCloset is a web page for a made-up fictional company. The company is supposed to be a subscription-based clothing company where customers pick a plan and the company will send them a monthly box full of clothes and accessories. Designed on Adobe XD, made with HTML5 and SASS using the BEM (Block, Element, Modifier) methodology, also used Javascript's library ScrollReveal  for quickly animating elements as they enter the viewport on the desktop view. Hosted on Netlify. Disclaimer: The images on the website are not optimized, because of that the website might take a little bit more time at the begging to fully load.",
    languajes: [
